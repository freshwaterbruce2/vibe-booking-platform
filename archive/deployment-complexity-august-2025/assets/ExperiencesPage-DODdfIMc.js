import { j as e, L as a } from './index-Bz50S9TB.js';
import { _ as i, y as l, $ as r, a0 as o, a1 as n, h as c } from './ui-c8TFxX-w.js';
              ...
              children: e.jsxs('div', {
                children: [
                  ...
                  e.jsx('p', {
                    ...
                    children:
                      'Transform your stay into an unforgettable journey with our handpicked luxury experiences',
                  }),
                ],
              }),
            }),
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsx('h2', {
                  ...
                  children: 'Popular Experiences',
                }),
                e.jsx('p', {
                  className: 'text-lg text-slate-600',
                  children: 'Book exclusive activities and create memories that last a lifetime',
                }),
              ],
            }),
            e.jsx('div', {
              ...
              children: d.map((t) => {
                ...
                return e.jsxs(
                  ...
                  {
                    className:
                      'group cursor-pointer rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-white',
                    children: [
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('div', {
                            ...
                            children: e.jsx('span', {
                              className:
                                'px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-sm font-semibold text-slate-700',
                              children: t.category,
                            }),
                          }),
                          e.jsxs('div', {
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('span', {
                                    ...
                                    children: [e.jsx(s, { className: 'w-4 h-4' }), t.duration],
                                  }),
                                  e.jsxs('span', {
                                    className: 'flex items-center gap-1',
                                    children: ['⭐ ', t.rating],
                      ...
                      e.jsx('div', {
                        ...
                        children: e.jsxs('div', {
                          ...
                          children: [
                            ...
                            e.jsx('button', {
                              className:
                                'px-6 py-3 bg-gradient-to-r from-slate-700 to-slate-800 text-white rounded-xl hover:from-slate-800 hover:to-slate-900 transition-all duration-300 font-semibold',
                              children: 'Book Now',
                            }),
                          ],
                        }),
...
export { p as default };
//# sourceMappingURL=ExperiencesPage-DODdfIMc.js.map
