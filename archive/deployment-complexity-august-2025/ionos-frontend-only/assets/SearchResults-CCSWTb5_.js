import { u as f, b as v, j as e, c as n, C as g, B as l } from './index-BipxYy_H.js';
import { r as N, u as b } from './vendor-VgjaNQN2.js';
import { T as w, U as o } from './UrgencyIndicator-DsGkK3UM.js';
import {
  M as h,
  H as k,
  j as R,
...
const E = ({ onHotelSelect: m, className: d = '' }) => {
    const p = b(),
    ...
    return y
                  ...
                  g,
                  {
                    ...
                    children: e.jsxs('div', {
                      ...
                      children: [
                        e.jsx('div', {
                          className:
                            'w-full lg:w-96 h-48 sm:h-56 lg:h-48 bg-gray-300 dark:bg-gray-600 rounded-lg',
                        }),
                        e.jsxs('div', {
      ...
      : x.length === 0
        ? e.jsx('div', {
            className: n('text-center py-12', d),
            children: e.jsxs('div', {
                                      ...
                                      e.jsxs('div', {
                                        ...
                                        children: [
                                          ...
                                          e.jsxs('div', {
                                            ...
                                            children: [
                                              c(a.priceRange.avgNightly * 3, a.priceRange.currency),
                                              ' total (3 nights)',
                                            ],
                                          }),
                                          a.priceRange.originalPrice &&
  ...
  B = N.memo(E);
export { E as SearchResults, B as default };
//# sourceMappingURL=SearchResults-CCSWTb5_.js.map
