...
async function testCompleteBooking() {
  ...
  try {
    ...
    const continueButton = page
      .locator('button:has-text("Continue"), .continue-button, button:has-text("Next")')
      .first();
    ...
    if (await continueButton.isVisible()) {
      ...
      const guestInputs = [
        {
          selector: 'input[name*="first"], input[placeholder*="First"], input[name*="firstName"]',
          value: 'John',
          label: 'First Name',
        },
        {
          selector: 'input[name*="last"], input[placeholder*="Last"], input[name*="lastName"]',
          value: 'Doe',
          label: 'Last Name',
        },
        {
        ...
        {
          selector: 'input[name*="zip"], input[name*="postal"], input[placeholder*="ZIP"]',
          value: '10001',
          label: 'ZIP Code',
        },
      ];
      ...
      await page.screenshot({
        path: 'screenshots/complete-03-guest-info-filled.png',
        fullPage: true,
      });
        ...
        if (squareAnalysis.squareSDK) {
          ...
          if (squareAnalysis.squareObjects.length > 0) {
              ...
              return new Promise((resolve) => {
                try {
                  ...
                  const cardContainer = document.querySelector(
                    '#card-container, #sq-card-number, input[placeholder*="Card"]',
                  );
            ...
            for (const selector of cardInputs) {
              try {
                ...
                if (await input.isVisible({ timeout: 1000 })) {
                  ...
                  await page.screenshot({
                    path: 'screenshots/complete-05-card-filled.png',
                    fullPage: true,
                  });
                  break;
                }
            ...
            if (cardInputFound) {
              ...
              const otherFields = [
                {
                  selector: '#sq-expiration-date, input[placeholder*="MM/YY"]',
                  value: '12/28',
                  label: 'Expiry',
                },
                { selector: '#sq-cvv, input[placeholder*="CVV"]', value: '123', label: 'CVV' },
                {
                  selector: '#sq-postal-code, input[placeholder*="ZIP"]',
                  value: '10001',
                  label: 'ZIP',
                },
              ];
              ...
              await page.screenshot({
                path: 'screenshots/complete-06-payment-complete.png',
                fullPage: true,
              });
              ...
              for (const selector of submitButtons) {
                ...
                if (await button.isVisible({ timeout: 1000 })) {
                  ...
                  await page.screenshot({
                    path: 'screenshots/complete-07-ready-to-pay.png',
                    fullPage: true,
                  });
                  break;
                }
