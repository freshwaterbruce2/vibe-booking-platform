...
export const bookings = sqliteTable('bookings', {
  ...
  confirmationNumber: text('confirmation_number', { length: 20 }).notNull().unique(),
  ...
  paymentStatus: text('payment_status', { length: 20 }).notNull().default('pending'),
  ...
  // Cancellation
  isCancellable: integer('is_cancellable', { mode: 'boolean' }).notNull().default(true),
  cancellationDeadline: integer('cancellation_deadline', { mode: 'timestamp' }),
