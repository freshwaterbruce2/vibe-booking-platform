...
export const hotels = sqliteTable('hotels', {
  ...
  // Meta
  checkInTime: text('check_in_time', { length: 10 }).notNull().default('15:00'),
  checkOutTime: text('check_out_time', { length: 10 }).notNull().default('11:00'),
  ...
  return {
    ...
    cityCountryIdx: index('hotels_city_country_idx').on(table.city, table.country),
