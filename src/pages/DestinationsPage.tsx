    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-blue-100 max-w-3xl">
            Discover amazing hotels in top cities across the United States. 
            From vibrant nightlife to peaceful beaches, find your perfect getaway.
          </p>
        </div>
      </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="text-sm">
                    <span className="font-semibold text-gray-900">{destination.hotels}</span>
      ...
      <div className="bg-blue-50 py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-4">Can't find your destination?</h2>
          <p className="text-gray-600 mb-6">
            We have hotels in over 200 cities worldwide. Search for any location!
          </p>
          <button
