...
import { Award, Crown, Gem, Trophy, Star, TrendingUp, Gift, Shield } from 'lucide-react';
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-12">
              Join the world's most rewarding hotel loyalty program. Earn points, unlock exclusive perks, 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: 'Redeem points for free nights, upgrades, and exclusive experiences',
                },
              ].map((item) => (
