...
import { Clock, Tag, TrendingDown, Calendar, MapPin, Star, ChevronRight, Zap } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 bg-white/20 backdrop-blur-sm rounded-lg p-4 inline-flex items-center gap-3">
            ...
            <span className="font-medium">Flash Sale: 17 deals ending in the next 48 hours!</span>
          </div>
        </div>
      </div>
          ...
          {sortedDeals.map((deal) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">{deal.hotel}</h3>
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-bold">
                    Save ${calculateSavings(deal.originalPrice, deal.discountPrice)}
                  </span>
                </div>
                ...
                {/* Includes */}
                <div className="mb-4">
                  <p className="text-xs text-gray-500 mb-1">This deal includes:</p>
