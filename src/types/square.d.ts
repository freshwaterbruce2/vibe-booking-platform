...
declare module '@square/web-sdk' {
  ...
  export interface Card { tokenize(): Promise<TokenResult>; }
  export interface Payments { card(): Promise<Card>; }
}
...
interface SquareGlobal { payments(appId: string, locationId: string): Promise<SquarePayments>; }
