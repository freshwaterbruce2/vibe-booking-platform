...
import { Search, MapPin, Calendar, Users, TrendingUp, Clock, Star, Sparkles } from 'lucide-react';
...
export function IntelligentSearchBar() {
  ...
  return (
    <>
                ...
                <div className="p-2 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {trendingSearches.map((trend) => (
                      ...
                      >
                        <span className="text-sm text-gray-700 group-hover:text-gray-900">{trend.term}</span>
                        <span className="text-xs text-green-600 font-medium">{trend.increase}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-2 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {popularDestinations.map((dest) => (
                      ...
                      >
                        <div className="text-sm font-medium text-gray-700 group-hover:text-gray-900">{dest.city}</div>
      ...
      {isVisible && (
        <div className={`${isCompact ? 'h-16' : 'h-32'} transition-all duration-300`} />
      )}
    </>
  );
}