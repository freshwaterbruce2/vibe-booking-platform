...
import { X, Mail, Lock, User, Check, Award, Gift, Percent, Star } from 'lucide-react';
...
export function MemberLoginModal({ isOpen, onClose }: MemberLoginModalProps) {
  ...
  const memberBenefits = [
    { icon: Percent, title: 'Exclusive Member Rates', desc: 'Save up to 15% on every stay' },
    { icon: Award, title: 'Elite Status Benefits', desc: 'Earn points and unlock perks' },
    { icon: Gift, title: 'Birthday Rewards', desc: 'Special offers on your special day' },
    { icon: Star, title: 'Priority Check-in', desc: 'Skip the line at 5000+ hotels' },
  ];
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-8 lg:p-12 text-white">
              <div className="mb-8">
                ...
                <p className="text-blue-100">Join millions of members enjoying exclusive benefits</p>
              </div>
                  ...
                  return (
                    <div key={benefit.title} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-100 mt-1">{benefit.desc}</p>
                      </div>
                    </div>
                  );
                })}
