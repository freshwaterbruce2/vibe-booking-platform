      ...
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            ...
            <p><strong>Dates:</strong> {format(booking.checkIn, 'MMM dd')} - {format(booking.checkOut, 'MMM dd, yyyy')}</p>
            ...
            {cancellationFee > 0 && (
              <div className="flex justify-between">
                ...
                <span className="font-medium text-red-600">
                  -{PaymentService.formatCurrency(cancellationFee, booking.currency)}
                </span>
              </div>
            )}
            ...
            <div className="border-t border-blue-200 pt-2">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-green-600">
                  {PaymentService.formatCurrency(refundAmount, booking.currency)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-yellow-700 space-y-1 list-disc list-inside">
                ...
                <li>50% refund for cancellations 12-24 hours before check-in</li>
