...
export const PaymentConfirmation: React.FC<PaymentConfirmationProps> = ({
  ...
  const commissionAmount = PaymentService.calculateCommission(bookingDetails.totalAmount);
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <p className="font-medium text-gray-900">{bookingDetails.hotelName}</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <p className="text-gray-600">
                  <strong>Check-in:</strong> {format(bookingDetails.checkIn, 'PPP')}
                </p>
                <p className="text-gray-600">
                  <strong>Check-out:</strong> {format(bookingDetails.checkOut, 'PPP')}
                </p>
                <p className="text-gray-600">
                  <strong>Duration:</strong> {bookingDetails.nights} night{bookingDetails.nights !== 1 ? 's' : ''}
                </p>
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <p className="text-gray-600">
                  <strong>Name:</strong> {bookingDetails.guestFirstName} {bookingDetails.guestLastName}
                </p>
                <p className="text-gray-600 flex items-center">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {PaymentService.formatCurrency(baseAmount, bookingDetails.currency)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Taxes & Fees</span>
              <span className="font-medium">
                {PaymentService.formatCurrency(taxAmount, bookingDetails.currency)}
              </span>
            </div>
            <div className="flex justify-between items-center">
