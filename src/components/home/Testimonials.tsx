...
const Testimonials: React.FC<TestimonialsProps> = ({
  testimonials = [
    ...
    },
    {
      ...
      hotelImage: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=400&h=300&fit=crop',
    ...
    },
    {
      ...
      hotelImage: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400&h=300&fit=crop',
    ...
    },
    {
      ...
      hotelImage: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=300&fit=crop',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See why millions choose Vibe Booking for their perfect hotel experience
          </p>
        </div>
                ...
                {testimonial.hotelImage && (
                  <div className="relative h-48 -mx-px -mt-px mb-6">
                    ...
                    <div className="absolute bottom-4 left-6 right-6 text-white">
                      <p className="font-bold text-lg drop-shadow-lg">{testimonial.hotelStayed}</p>
                      <p className="text-sm opacity-90">{testimonial.dateStayed}</p>
                    </div>
        ...
        <div className="lg:hidden">
          <div className="relative">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden mx-4">
              {/* Hotel Image */}
              {testimonials[currentIndex].hotelImage && (
                <div className="relative h-40">
                  <OptimizedImage
                    src={testimonials[currentIndex].hotelImage}
                    alt={testimonials[currentIndex].hotelStayed}
                  ...
                  <div className="absolute bottom-3 left-4 right-4 text-white">
                    <p className="font-bold text-base drop-shadow-lg">{testimonials[currentIndex].hotelStayed}</p>
                    <p className="text-xs opacity-90">{testimonials[currentIndex].dateStayed}</p>
                  </div>
                </div>
              )}
