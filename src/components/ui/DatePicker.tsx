...
return false;
  ...
  const handleApply = () => {
    if (isValidDateRange()) {
      ...
      setGuestCount(localGuestCount.adults, localGuestCount.children, localGuestCount.rooms);
      onClose?.();
    }
  };
                  ...
                  {[
                    ...
                    return (
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          setCheckInDate(dates.start.toISOString().split('T')[0]);
                          setCheckOutDate(dates.end.toISOString().split('T')[0]);
                        }}
                        className="text-xs"
                      >
                        {option.label}
