...
import { 
  Hotel, Search, Heart, MapPin, Calendar, Users, 
  Globe, DollarSign, Award, Sparkles, Star, Menu, X,
  TrendingUp, Shield, Phone
} from 'lucide-react';
          ...
          <div className="flex items-center justify-between px-4 py-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Premium Hotel Collection</p>
              </div>
            </Link>
