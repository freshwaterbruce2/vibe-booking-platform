...
describe('Accessibility Tests', () => {
  describe('SearchSection Component', () => {
    ...
    it('should have proper button accessibility', async () => {
      const { container } = render(<SearchSection onSearch={vi.fn()} isLoading={false} />);
    ...
    it('should handle loading state accessibly', async () => {
      const { container } = render(<SearchSection onSearch={vi.fn()} isLoading={true} />);
  ...
  describe('SearchResults Component', () => {
    ...
    it('should have accessible empty state', async () => {
      ...
      expect(emptyMessage).toHaveTextContent('Try adjusting your search criteria');
  ...
  describe('PaymentForm Component', () => {
    ...
    it('should handle loading state accessibly', async () => {
      ...
      const loadingText = container.querySelector('span:has-text("Loading payment system...")');
      if (loadingText) {
    ...
    it('should have accessible error states', async () => {
      ...
      vi.mocked(require('@/services/payment')).stripePromise = Promise.resolve(null);
      ...
      const errorHeading = container.querySelector('h3:has-text("Payment System Error")');
      if (errorHeading) {
  ...
  describe('Custom Accessibility Rules', () => {
    it('should follow hotel booking specific accessibility guidelines', async () => {
      ...
      const hotelCards = container.querySelectorAll('[data-testid="hotel-card"]');
