...
describe('SearchResults', () => {
  const mockHotels = [
    {
      ...
      description: 'A luxurious hotel in the heart of the city with amazing amenities.',
      location: {
        city: 'Test City',
  ...
  describe('Empty State', () => {
    it('should show empty state when no hotels found', () => {
      ...
      expect(screen.getByText('Try adjusting your search criteria or explore different dates')).toBeInTheDocument();
