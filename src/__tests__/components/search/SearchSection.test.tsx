...
describe('SearchSection', () => {
  ...
  describe('Search Button Behavior', () => {
    ...
    it('should not call onSearch when button is disabled', async () => {
      ...
      render(<SearchSection {...defaultProps} onSearch={mockOnSearch} isLoading={true} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should support keyboard navigation', async () => {
      ...
      await user.tab();
      expect(screen.getByRole('button', { name: /search hotels/i })).toHaveFocus();
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty className prop', () => {
      const { container } = render(<SearchSection {...defaultProps} className="" />);
      
      expect(container.firstChild).toHaveClass('bg-white', 'rounded-lg', 'shadow-lg');
    });
