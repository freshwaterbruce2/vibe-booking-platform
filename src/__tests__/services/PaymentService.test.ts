...
describe('PaymentService', () => {
  ...
  describe('confirmPaymentIntent', () => {
    ...
    it('should confirm payment intent successfully', async () => {
      ...
      const result = await PaymentService.confirmPaymentIntent('pi_test_123', 'pm_test_456');
  ...
  describe('getPaymentStatus', () => {
    ...
    it('should get payment status successfully', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/payments/status/pi_test_123');
  ...
  describe('getBookingPayments', () => {
    ...
    it('should get booking payments successfully', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/payments/booking/booking-123');
  ...
  describe('getPaymentHistory', () => {
    ...
    it('should get payment history with default parameters', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/payments/history?page=1&limit=10');
    ...
    it('should get payment history with custom parameters', async () => {
      ...
      await PaymentService.getPaymentHistory(2, 20, 'completed', startDate, endDate);

      const expectedUrl = '/payments/history?page=2&limit=20&status=completed&startDate=2023-12-01T00:00:00.000Z&endDate=2023-12-31T00:00:00.000Z';
  ...
  describe('createSetupIntent', () => {
    ...
    it('should create setup intent successfully', async () => {
      ...
      const result = await PaymentService.createSetupIntent({ userId: 'user-123' });

      expect(mockApiClient.post).toHaveBeenCalledWith('/payments/setup-intent', {
  ...
  describe('Utility Methods', () => {
    describe('formatCurrency', () => {
      ...
      it('should handle decimal amounts', () => {
        ...
        expect(PaymentService.formatCurrency(0.50)).toBe('$0.50');
      });
    });
    ...
    describe('getPaymentStatusColor', () => {
      it('should return correct colors for different statuses', () => {
        expect(PaymentService.getPaymentStatusColor('completed')).toBe('text-green-600');
        expect(PaymentService.getPaymentStatusColor('pending')).toBe('text-yellow-600');
        expect(PaymentService.getPaymentStatusColor('failed')).toBe('text-red-600');
        expect(PaymentService.getPaymentStatusColor('canceled')).toBe('text-gray-600');
        expect(PaymentService.getPaymentStatusColor('processing')).toBe('text-blue-600');
      });

      it('should return default color for unknown status', () => {
        expect(PaymentService.getPaymentStatusColor('unknown')).toBe('text-gray-600');
    ...
    describe('validatePaymentAmount', () => {
      it('should validate USD amounts correctly', () => {
        expect(PaymentService.validatePaymentAmount(0.50, 'USD')).toBe(true);
  ...
  describe('Error Handling Patterns', () => {
    it('should consistently handle API errors across methods', async () => {
      ...
      mockApiClient.post.mockResolvedValue({ data: { success: false, message: 'API Error' } });
      mockApiClient.get.mockResolvedValue({ data: { success: false, message: 'API Error' } });
