...
import { bookingService, type BookingData, type Booking } from '@/services/bookingService';
import { MockDataGenerator, mockApiResponses } from '../fixtures/mockDataGenerators';
...
describe('BookingService', () => {
  ...
  describe('getBooking', () => {
    ...
    it('should retrieve booking by confirmation number', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith('/api/bookings/confirmation/CONF456');
      expect(result).toEqual(mockBooking);
    });
  });
  ...
  describe('getUserBookings', () => {
    it('should retrieve user bookings with pagination', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith('/api/bookings/user/user-789?page=1&limit=10');
    ...
    it('should handle custom pagination parameters', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith('/api/bookings/user/user-789?page=2&limit=5');
    });
    ...
    it('should filter bookings by status', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith('/api/bookings/user/user-789?page=1&limit=10&status=confirmed');
    });
  });
  ...
  describe('updateBooking', () => {
    it('should update booking successfully', async () => {
      ...
      const result = await bookingService.updateBooking('booking-123', updateData);

      expect(mockedAxios.put).toHaveBeenCalledWith('/api/bookings/booking-123', updateData);
    ...
    it('should handle booking update failure', async () => {
      ...
      await expect(
        bookingService.updateBooking('booking-123', { specialRequests: 'New requests' })
  ...
  describe('cancelBooking', () => {
    it('should cancel booking successfully', async () => {
      ...
      const result = await bookingService.cancelBooking('booking-123', 'Customer request');

      expect(mockedAxios.put).toHaveBeenCalledWith('/api/bookings/booking-123/cancel', {
    ...
    it('should calculate correct refund amount', async () => {
      ...
      const result = await bookingService.cancelBooking('booking-123', 'Change of plans');
  ...
  describe('checkAvailability', () => {
    it('should check room availability', async () => {
      ...
      expect(mockedAxios.post).toHaveBeenCalledWith('/api/bookings/availability', searchParams);
  ...
  describe('Validation', () => {
    it('should validate email format', () => {
      ...
      expect(() => bookingService.validateBookingData(invalidBookingData))
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long special requests', async () => {
      ...
      expect(() => bookingService.validateBookingData(longRequestBookingData))
    ...
    it('should handle booking far in the future', async () => {
      ...
      const futureBookingData = {
        ...
        checkOut: new Date(futureDate.getTime() + 86400000).toISOString().split('T')[0],
      };
  ...
  describe('Integration Scenarios', () => {
    ...
    it('should handle booking cancellation with refund', async () => {
      ...
      const cancellationResult = await bookingService.cancelBooking('booking-123', 'Travel plans changed');
