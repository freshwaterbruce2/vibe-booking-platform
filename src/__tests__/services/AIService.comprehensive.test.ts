...
describe('AIService Comprehensive Tests', () => {
  ...
  describe('Natural Language Processing', () => {
    it('should process natural language query successfully', async () => {
      ...
      const query = 'Find me a luxury hotel in New York for 2 guests from Dec 1-3, budget $100-300';
    ...
    it('should handle complex natural language queries', async () => {
      ...
      const mockResponse: ProcessedQuery = {
        ...
        confidence: 0.88,
        suggestions: ['romantic hotels', 'spa hotels', 'luxury hotels near Eiffel Tower'],
      };
    ...
    it('should handle ambiguous queries with lower confidence', async () => {
      ...
      const mockResponse: ProcessedQuery = {
        ...
        entities: {},
        confidence: 0.3,
        suggestions: ['Please specify location', 'Add check-in dates', 'Specify number of guests'],
  ...
  describe('AI Recommendations', () => {
    it('should get recommendations with full context', async () => {
      ...
      const mockRecommendations = {
        hotels: [
          {
            ...
            score: 0.95,
            reasons: ['Matches luxury preference', 'Has gym', 'Business center'],
          },
          {
            id: 'hotel_2',
        ...
        personalizedTips: ['Book early for better rates', 'Consider hotel loyalty programs'],
      };
    ...
    it('should handle recommendations with minimal context', async () => {
      ...
      const mockRecommendations = {
        ...
        personalizedTips: ['Consider adding preferences for better recommendations'],
      };
        ...
        hotels: [
          {
            ...
            luxuryFeatures: ['Butler service', 'Private beach', 'Helicopter transfers'],
          },
        ],
    ...
    it('should handle empty recommendations gracefully', async () => {
      ...
      const mockRecommendations = {
        ...
        alternatives: ['Expand search radius', 'Increase budget', 'Try nearby cities'],
      };
    ...
    it('should handle recommendation API errors', async () => {
      mockedAxios.post.mockRejectedValue(new Error('Recommendation service unavailable'));
  ...
  describe('Sentiment Analysis', () => {
    it('should analyze positive sentiment correctly', async () => {
      const positiveText = 'This hotel was absolutely amazing! The staff was incredibly friendly and the room was perfect.';
    ...
    it('should analyze negative sentiment correctly', async () => {
      const negativeText = 'Terrible experience. The room was dirty, staff was rude, and the location was awful.';
    ...
    it('should analyze neutral sentiment', async () => {
      const neutralText = 'The hotel was okay. Nothing special but met basic needs.';
    ...
    it('should handle mixed sentiment', async () => {
      const mixedText = 'Great location and beautiful views, but the service was disappointing and overpriced.';
    ...
    it('should handle multilingual sentiment analysis', async () => {
      const spanishText = 'El hotel era fantástico, muy limpio y el personal muy amable.';
    ...
    it('should handle sentiment analysis API errors', async () => {
      mockedAxios.post.mockRejectedValue(new Error('Sentiment analysis failed'));

      await expect(
        aiService.analyzeSentiment('Test text')
      ).rejects.toThrow('Failed to analyze sentiment');
    });
  });
  ...
  describe('Edge Cases and Performance', () => {
    ...
    it('should handle special characters and emojis', async () => {
      const emojiText = 'Hotel was great! 😊👍 Would definitely recommend! 5 ⭐⭐⭐⭐⭐';
