...
class NotificationService {
  ...
  async sendBookingConfirmation(_userId: string, _bookingId: string, confirmationNumber: string, hotelName: string) {
    this.success('Booking Confirmed!', {
      description: `Your booking at ${hotelName} has been confirmed. Confirmation #${confirmationNumber}`,
    });
  }

  async sendBookingCancellation(_bookingId: string, hotelName: string, _totalAmount: number, reason?: string) {
