...
return;
    ...
    try {
      ...
      if (this.config.sentryDsn && typeof window !== 'undefined') {
        ...
        console.log('✅ Error tracking will be initialized when Sentry is installed');
      }
...
return;
  ...
  private async sendToErrorEndpoint(error: Error, context?: Record<string, any>) {
    try {
...
export const trackBookingCompleted = (bookingId: string, amount: number, userId?: string) => {
  monitoring.trackBusinessEvent({
...
export const trackPaymentStarted = (bookingId: string, amount: number, userId?: string) => {
  monitoring.trackBusinessEvent({
...
export const trackPaymentCompleted = (paymentId: string, amount: number, userId?: string) => {
  monitoring.trackBusinessEvent({
...
export const trackSearchPerformed = (query: string, resultsCount: number, userId?: string) => {
  monitoring.trackBusinessEvent({
